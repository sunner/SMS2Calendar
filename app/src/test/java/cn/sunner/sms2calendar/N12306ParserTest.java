...
public class N12306ParserTest {
    ...
    public void testOneSeat() throws Exception {
        ...
        assertEquals(new GregorianCalendar(2016, 1, 24, 19, 11), parser.getDate());
    }
    ...
    public void testTwoSeatsAndChanged() throws Exception {
        ...
        assertEquals(new GregorianCalendar(2016, 12, 9, 19, 11), parser.getDate());
    }
    ...
    public void testTwoBeds() throws Exception {
        ...
        assertEquals(new GregorianCalendar(2016, 2, 1, 9, 30), parser.getDate());
    }
